...
const ClientButtons = () => {
  ...
  const handleLocalPlayClick = (e) => {
    if (!profile) {
      e.preventDefault();
      setMissingFields(['firstName', 'gender', 'ageRange', 'skillLevel', 'zipCode', 'openForMatches', 'aboutYou', 'phone', 'email', 'profileImage', 'casualCompetitive', 'outdoorIndoor', 'rightieLeftie']);
      ...
      {isLocalPlayModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white text-black rounded-lg p-8 m-4 max-w-xs max-h-full text-center">
            ...
            <p className="mb-4">
              To access local matchmaking, you need to complete your profile. Please fill in all the required fields on the profile page.
            </p>
